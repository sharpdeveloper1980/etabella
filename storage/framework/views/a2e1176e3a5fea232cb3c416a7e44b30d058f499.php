      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <input type="hidden" name="document_id1" id="document_id1" value="<?php echo Request::segment(3); ?>">
            <input type="hidden" name="client_id" id="client_id" value="<?php echo $notofocation_main->sender;; ?>">
            <input type="hidden" name="d1" id="d1" value="<?php echo $notofocation_main->file_id;; ?>">
          </div>
          <div class="form-group">
