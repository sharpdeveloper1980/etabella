...
<div><img src="<?php echo e(asset('public/frontend/img/image.png')); ?>" style="width:100%"> </div>
<div>
         ...
         <div class="row" style="margin-bottom: 43px;">
            ...
            <div class="col-md-4 col-sm-6 col-xs-12" >
               <div class="service-item">
                  <center><img src="<?php echo e(asset('public/frontend/img/female_8.png')); ?>" style="height: 70px;width: 70px;/*! alingn: cem; */"></center>
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
               <div class="service-item">
                  <center><img src="<?php echo e(asset('public/frontend/img/face_human_blank_user_avatar_mannequin_dummy-128.png')); ?>" style="height: 70px;width: 70px;/*! alingn: cem; */"></center>
                  <center>jane doe</center>
                  <center>
