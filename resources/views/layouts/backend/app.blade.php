...
<!-- =============== VENDOR STYLES ===============-->
   ...
   <!-- SIMPLE LINE ICONS-->
   <link rel="stylesheet" href="{{asset('public/backend/vendor/simple-line-icons/css/simple-line-icons.css')}}">
   <!-- ANIMATE.CSS-->
   <link rel="stylesheet" href="{{asset('public/backend/vendor/animate.css/animate.min.css')}}">
   <!-- WHIRL (spinners)-->
   <link rel="stylesheet" href="{{asset('public/backend/vendor/whirl/dist/whirl.css')}}">
   <!-- =============== PAGE VENDOR STYLES ===============-->
   <!-- WEATHER ICONS-->
   <link rel="stylesheet" href="{{asset('public/backend/vendor/weather-icons/css/weather-icons.min.css')}}">
   <link rel="stylesheet" href="{{asset('public/backend/vendor/sweetalert/dist/sweetalert.css')}}">
   <link rel="stylesheet" href="{{asset('public/backend/vendor/loaders.css/loaders.css')}}">
   <!-- =============== BOOTSTRAP STYLES ===============-->
   <link rel="stylesheet" href="{{asset('public/backend/css/bootstrap.css')}}" id="bscss">
   <!-- =============== APP STYLES ===============-->
   <link rel="stylesheet" href="{{asset('public/backend/css/app.css')}}" id="maincss">
   <link rel="stylesheet" href="{{asset('public/backend/css/theme-a.css')}}">
...
<body>
    <div class="wrapper">
      ...
      <header class="topnavbar-wrapper">
            ...
            <div class="navbar-header">
               <a href="#/" class="navbar-brand">
                  <div class="brand-logo">
                     <img src="{{ asset('public/img/logo.png') }}" alt="" class="img-responsive">
                  </div>
                  <div class="brand-logo-collapsed">
                     <img src="{{asset('public/img/logo-single.png')}}" alt="" class="img-responsive">
                  </div>
               </a>
            </div>
            <!-- END navbar header-->
         ...
         @include('layouts.backend.partial')
         @yield('content')
      <footer>
   ...
   <!-- STORAGE API-->
   <script src="{{ asset('public/backend/vendor/jQuery-Storage-API/jquery.storageapi.js') }}"></script>
   <!-- BOOTSTRAP-->
   <script src="{{ asset('public/backend/vendor/bootstrap/dist/js/bootstrap.js') }}"></script>
   <!-- ANIMO-->
   <script src="{{ asset('public/backend/vendor/animo.js/animo.js') }}"></script>
   <!-- SLIMSCROLL-->
   <script src="{{ asset('public/backend/vendor/slimScroll/jquery.slimscroll.min.js') }}"></script>
   <!-- LOCALIZE-->
   <script src="{{ asset('public/backend/vendor/jquery-localize-i18n/dist/jquery.localize.js') }}"></script>
   <!-- CLASSY LOADER-->
   <script src="{{ asset('public/backend/vendor/jquery-classyloader/js/jquery.classyloader.min.js') }}"></script>
   <!-- SWEET ALERT-->
   ...
   <script src="{{ asset('public/backend/js/demo/demo-flot.js') }}"></script>
   <!-- <script src="{{ asset('public/backend/js/app.js') }}"></script>
   <script src="{{ asset('public/backend/js/etabella.js') }}"></script> -->
