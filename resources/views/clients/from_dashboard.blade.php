		...
		<div class="card">
			<div class="card-header custom_cart_header" style="display:none">
				<ul class="list-inline custom-toolbar">
				  <li style="width:14%;float: left;"><a href="{{ url('clients/dashboard') }}" id="">Back</a></li>
				  <li style="width: 86%; text-align: center; color: #E54E09;"><b><center>{{$file->file_name}}</center></b></li>
				</ul>
			</div>
			<div class="card-body">
