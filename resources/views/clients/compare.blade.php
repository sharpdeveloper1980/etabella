					...
					<div class="card-header custom_cart_header">
						<div class="row custom-toolbar-parent">
						  <ul class="list-inline custom-toolbar">
							...
							<li class="test-0" style="width: 51%; text-align: center; color: #E54E09;"><b> @if(strlen($file_1->file_name) > 44) {{ substr($file_1->file_name, 0, 40) . '...' }} @else {{ $file_1->file_name }} @endif </b></li>
					...
					<div class="card-header custom_cart_header">
						<div class="row custom-toolbar-parent">
						  <ul class="list-inline custom-toolbar">
							...
							<li class="test-0" style="width: 63%; text-align: center; color: #E54E09;"><b style="margin-left: 100px;"> @if(strlen($file_2->file_name) > 44) {{ substr($file_2->file_name, 0, 40) . '...' }} @else {{ $file_2->file_name }} @endif </b></li>
