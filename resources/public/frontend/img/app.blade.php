	...
	<div class="wrapper">
		...
		<div class="row">
			<div class="col-sm-12 text-center">
				<a href="<?php echo url('clients') ?>" class="brand-link">
				<img src="{{ url('') }}/public/frontend/img/logo_new.png" alt="eTabella" class="brand-image " style="opacity: .8;max-width: 108px;margin-top: 10px;"> 
			</a>
			</div>
		</div>
